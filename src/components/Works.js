  ...
  return (
    <div className="works container">
      <div className="works-title" style={styleHide}>
        <p>
          Nuestras <strong>misiones</strong>
        </p>
      ...
      <div className="works-cards">
        <div className="work master">
          ...
          <div className="btns">
            ...
            <p style={styleShow}>
              ...
              informativo acerca del club y de las instalaciones, informaciones
              y contactos de los profesores, y además gestiona los turnos para
              el alquiler de las canchas tanto de Tenis como de Paddle.
            </p>
        ...
        <div className="work grindoil">
          ...
          <div className="btns">
            ...
            <p style={styleShow}>
              Página web informativa acerca de una empresa aceitera, consta con
              información acerca de sus procesos y productos, sus clientes y
              sección de contacto para personas interesadas.
            </p>
            <div className="btn-container">
              <Link to="/trabajos" className="btn" style={styleHide}>
                Conoce Más
        ...
        <div className="work autoestimeitor">
          ...
          <div className="btns">
            <h3>Juego interactivo para el autoestima</h3>
            <p style={styleShow}>
